...
BOOL CHoverCadApp::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(IDR_HCADTYPE, RUNTIME_CLASS(CHoverCadDoc), RUNTIME_CLASS(CChildFrame),
...
void CHoverCadApp::OnHelpHelp()
{
	...
	if(lReturnCode <= 32) {
		...
		MessageBox(*m_pMainWnd, lMessage, lTitle, MB_ICONERROR | MB_APPLMODAL | MB_OK);
