...
int MR_GetTypeIndexFromType(int pId, CHoverType * pList, int pListSize);

#define GetTypeIndex( pId, pListName )  MR_GetTypeIndex( pId, pListName##List, pListName##ListSize )
#define GetTypeIndexFromType( pId, pListName )  MR_GetTypeIndexFromType( pId, pListName##List, pListName##ListSize )
