...
void MR_Element::AddRenderer() { /* The default function do notting */ }
...
void MR_Element::SerializeLogicState(CArchive& /*pArchive*/) { /* The default function do notting */ }
void MR_Element::Serialize(CArchive& pArchive) { MR_ObjectFromFactory::Serialize( pArchive ); }
...
const MR_ContactEffectList* MR_Element::GetEffectList() { return NULL; }
void MR_Element::ApplyEffects(const MR_ContactEffectList* pList,
							  MR_SimulationTime pTime,
							  MR_SimulationTime pDuration,
...
void MR_FreeElement::Render(MR_3DViewPort* /*pDest*/, MR_SimulationTime /*pTime*/) { /* Notting is rendered by default */ }
int MR_FreeElement::Simulate(MR_SimulationTime, MR_Level*, int pRoom) { /* Notting to do by default */ return pRoom; }
const MR_ShapeInterface* MR_FreeElement::GetObstacleShape() { return NULL; }
const MR_ShapeInterface* MR_FreeElement::GetReceivingContactEffectShape() { return NULL; }
const MR_ShapeInterface* MR_FreeElement::GetGivingContactEffectShape() { return NULL; }
void MR_FreeElement::PlayInternalSounds() { }
void MR_FreeElement::PlayExternalSounds(int /*pDB*/, int /*pPan*/) { }
BOOL MR_FreeElement::AssignPermNumber(int /*pNumber*/) { return FALSE; }
