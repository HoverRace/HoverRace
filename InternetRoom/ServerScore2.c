...
// HoverRace ScoreDaemon for Unix or Win32.
// (Current version only works on Unix because it used shared mem)
//
// This is a CGI application 
//
// Query form (version 1)
//
//   URL only       // print title
//   URL?=BESTLAPS  // Print best laps table
//   URL?=BESTLAPS1 // Print best laps table for all time
//   URL?=BESTLAPS2 // Print best laps table for this week
//   URL?=BESTTIME1 // Print best times table for track 1
//   URL?=BESTTIME2 // Print best times table for track 2
//   URL?=BESTTIME3 // Print best times table for track 3
//   URL?=BESTTIME4 // Print best times table for track 4
//   URL?=BESTTIME5 // Print best times table for track 5
//   URL?=LAPTIME LapTime TrackName Alias[Major-Minor] TrackSum CraftModel
//   URL?=RESULT  LapTime TrackName Alias[Major-Minor] TrackSum CraftModel TotalTime NbLap NbPlayer
//   URL?=RESET      // Reload the config from file
//   URL?=RESET_WEEK // RESET Weekly recrd list
//
//   Report command can also be passed on the command line
//
...
/* SCORE SERVER DATA */
#define IR_SEM_KEY         71426
#define IR_SHMEM_KEY       71426


#define IR_USER_NAME_LEN     18
#define IR_TRACK_NAME_LEN    32
#define IR_MAX_TRACK         20

/* Best times data */
#define IR_MAX_TRACK_BT       5
#define IR_MAX_PLAYER_BT     10
